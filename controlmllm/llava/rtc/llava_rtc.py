...
def parse_args():
    ...
    parser.add_argument('--data_path', type=str, default="data/RTC/COCO-Text", help='Path to the dataset')
    parser.add_argument('--question_file', type=str, default='data/RTC/question_rtc.json', help='Path to the question file')
    parser.add_argument('--answers_file', type=str, default='outputs/llava_rtc.json', help='Path to the answers file')
