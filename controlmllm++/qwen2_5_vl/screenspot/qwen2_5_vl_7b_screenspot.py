...
def parse_args():
    ...
    p.add_argument('--data_path', default="dataset/ScreenSpot")
    p.add_argument('--question_file', default='dataset/ScreenSpot/question_screenspot.json')
    p.add_argument('--answers_file', default='outputs/qwen2_5_vl_7b_screenspot.json')
...
def main():
    ...
    for q in tqdm(questions, desc="Qwen‑ScreenSpot"):
        img_path  = os.path.join(args.data_path, q['image_path'])
        ...
        if question == "What is this icon used for?":
            question = "What is this icon in {} used for? Respond with a short and direct answer without mentioning the coordinates.".format(location_text)
        elif question == "What does this text say?":
            question = "What does this text in {} say? Respond with a short and direct answer without mentioning the coordinates.".format(location_text)
