...
def parse_args():
    ...
    p.add_argument('--data_path', default="dataset/COCO2014/train2014")
    p.add_argument('--coco_annotation_path', type=str, default='dataset/COCO2014/annotations/instances_train2014.json', help='Path to COCO annotation file')
    p.add_argument('--question_file', default='dataset/COCO2014/refcocog.json')
    p.add_argument('--answers_file', default='outputs/qwen2_5_vl_7b_refcocog.json')
...
def main():
    ...
    for q in tqdm(questions, desc="Qwen‑Refcocog"):
        image_info = coco.loadImgs(q['image_id'])[0]
        img_path = args.data_path + image_info['file_name']
        ...
        if args.prompt_type == 'box':
            ...
            location_text = ""
        qid, label = q['image_id'], q['expressions']
        question = f"Can you provide me with a detailed description of the region in the picture marked by {location_text}"
